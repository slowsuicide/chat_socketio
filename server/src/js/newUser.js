const fs = require('fs')
const CURR_PROFILE_PHOTOS_DIRECTION = './src/profiles_photo/'
const CURR_RANDOM_NAMES_DIRECTION ='./src/other_info/randomNames.txt';
const CURR_RANDOM_NICKNAMES_DIRECTION = './src/other_info/randomNicknames.txt';
